/*
 * vtest.cpp contains a set of routines for evaluating a p-value, the
...
void Vtest_create(Vtest *vtest, unsigned int nvec)
{
	...
	//}
	vtest->x = new double [nvec];       /* sample results */
	vtest->y = new double [nvec];       /* expected sample results */
